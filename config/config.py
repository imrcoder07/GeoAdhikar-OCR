...
class Config:
    ...
    FIELD_PATTERNS = {
        ...
        'holder_name': [
            ...
            r'नाम\s*[:\-]?\s*([^\n]+)',  # Additional Hindi name pattern
            r'व्यक्ति\s*का\s*नाम\s*[:\-]?\s*([^\n]+)',
            r'बिक्रेता\s*[-:]?\s*([^\n,]+)',
            r'क्रेता\s*[-:]?\s*([^\n,]+)',
            r'(?:उत्तर|North)\s*[-:]?\s*([^\n,]+)',
            r'(?:दक्षिण|South)\s*[-:]?\s*([^\n,]+)',
        ...
        'village': [
            r'(?:गांव|ग्राम|Village|मौजा)\s*[-:]?\s*([^\n,]+)',
            r'ग्राम\s*पंचायत\s*[-:]?\s*([^\n,]+)',
            r'गाँव\s*[:\-]?\s*([^\n,]+)',
            r'मौजा\s*[-:]?\s*([^\n,]+)'
        ],
        'district': [
            r'(?:जिला|ज़िला|District|Zila|जिल्ला)\s*[-:]?\s*([^\n,]+)',
            r'जनपद\s*[-:]?\s*([^\n,]+)',
            r'जिल्ला\s*[:\-]?\s*([^\n,]+)',
            r'जिला\s*([^\n,]+?)(?:\s*अव)',
            r'धनबाद'
        ...
        'area': [
            ...
            r'(\d+(?:\.\d+)?)\s*(?:डिसमिल|dismil|decimal)',
            r'(\d+(?:\.\d+)?)\s*(?:कट्ठा|kattha)',
            r'रकवा\s*[-:]?\s*([^\n]+)'
        ],
        'plot_no': [
            r'प्लोट\s*नं[०-९]*\s*[-:]?\s*(\d+(?:\s*अंश)?)',
            r'प्लॉट\s*नं\.?\s*[-:]?\s*(\d+)',
            r'नया\s*प्लोट\s*नं\s*[-:]?\s*(\d+)'
        ]
    }
